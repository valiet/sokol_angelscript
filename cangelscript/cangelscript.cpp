...
public:
	...
	virtual int Write(const void *ptr, asUINT size) { write(ptr, size, param); }
	virtual int Read(void *ptr, asUINT size)  { read(ptr, size, param); }
...
extern "C"
{
	...
	// String factory
	AS_API int                asEngine_RegisterStringFactory(asIScriptEngine *e, const char *datatype, asIStringFactory *factory)																	   { return e->RegisterStringFactory(datatype, factory); }
