...
//	AS_API int               asAtomicDec(int &value);
	...
	// String factory
	AS_API int                asEngine_RegisterStringFactory(asIScriptEngine* e, const char* datatype, asIStringFactory* factory);
	...
	AS_API int                    asEngine_RefCastObject(asIScriptEngine *e, void *obj, asITypeInfo *fromType, asITypeInfo *toType, void **newPtr, asBOOL useOnlyImplicitCast);
